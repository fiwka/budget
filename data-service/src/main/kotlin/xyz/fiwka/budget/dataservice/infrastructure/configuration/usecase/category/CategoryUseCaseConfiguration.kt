...
import xyz.fiwka.budget.dataservice.application.service.category.ListBudgetCategoriesService
...
class CategoryUseCaseConfiguration {
    ...
    @Bean
    fun listBudgetCategoriesUseCase(
        budgetAccessGuard: BudgetAccessGuard,
        listBudgetCategoriesOutputPort: ListBudgetCategoriesOutputPort,
    ): ListBudgetCategoriesUseCase =
        ListBudgetCategoriesService(budgetAccessGuard, listBudgetCategoriesOutputPort)
