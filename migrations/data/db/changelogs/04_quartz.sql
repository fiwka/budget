...
(
    ...
    constraint qrtz_triggers_job_details_fk foreign key (sched_name, job_name, job_group)
...
(
    ...
    primary key (sched_name, trigger_name, trigger_group),
    constraint qrtz_simple_triggers_triggers_fk foreign key (sched_name, trigger_name, trigger_group)
...
(
    ...
    primary key (sched_name, trigger_name, trigger_group),
    constraint qrtz_cron_triggers_triggers_fk foreign key (sched_name, trigger_name, trigger_group)
        references qrtz_triggers (sched_name, trigger_name, trigger_group)
);
...
(
    ...
    primary key (sched_name, trigger_name, trigger_group),
    constraint qrtz_simprop_triggers_triggers_fk foreign key (sched_name, trigger_name, trigger_group)
        references qrtz_triggers (sched_name, trigger_name, trigger_group)
);
...
(
    ...
    primary key (sched_name, trigger_name, trigger_group),
    constraint qrtz_blob_triggers_triggers_fk foreign key (sched_name, trigger_name, trigger_group)
        references qrtz_triggers (sched_name, trigger_name, trigger_group)
);
...
values ('data-service-quartz', 'TRIGGER_ACCESS'),
       ('data-service-quartz', 'JOB_ACCESS'),
       ('data-service-quartz', 'CALENDAR_ACCESS'),
       ('data-service-quartz', 'STATE_ACCESS'),
       ('data-service-quartz', 'MISFIRE_ACCESS')
